...
public class AnimationAndMovementController : MonoBehaviour
{
    ...
    public float runMultiplier = 15f;
    public float speed = 10f;
    int zero = 0;

    // gravity variables
    public float gravity = -9.8f;
<<<<<<< HEAD:My project/Assets/ScriptsJ/AnimationAndMovementController.cs
    float groundedGravity = -.05f;
=======
    public float groundedGravity = -.05f;
>>>>>>> Jesper:My project/Assets/Scripts/ScriptsJ/AnimationAndMovementController.cs
...
=======
    public float maxJumpHeight = 2.9f;
...
>>>>>>> Jesper:My project/Assets/Scripts/ScriptsJ/AnimationAndMovementController.cs
    ...
    int jumpCount = 0;
    public bool ablteToMakeADoubleJump = true;
...
>>>>>>> Jesper:My project/Assets/Scripts/ScriptsJ/AnimationAndMovementController.cs
    ...
    void handleJump()
    {
        ...
        {
            if(ablteToMakeADoubleJump & !isJumping && characterController.isGrounded && isJumpPressed)
            {
                currentMovement.y = initialJumpVelocities[jumpCount];
                appliedMovement.y = initialJumpVelocities[jumpCount];
                ablteToMakeADoubleJump = false;
            }
        }
